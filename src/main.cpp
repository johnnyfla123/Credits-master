...
// Copyright (c) 2011-2013 Credits Developers.
...
bool IsInitialBlockDownload()
{
    ...
    return (GetTime() - nLastUpdate < 10 &&
            pindexBest->GetBlockTime() < GetTime() - 1 * 60 * 60);
}
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0666D77B9B62E0DB1FD6150ECFC5722F31FEE52E585DE31B5AEFAD2CAC415D5698991F8F0B0CBBA7B9F4431BBE79B684876EDFBD369554ACC4182753FA48A3CD80") << OP_CHECKSIG;
        CBlock block;
