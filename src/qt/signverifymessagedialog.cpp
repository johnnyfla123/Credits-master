    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a Credits address (e.g. CNS17iag9jJgTHD1VXjvLCEnZuQ3rJDE9L)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a Credits address (e.g. CNS17iag9jJgTHD1VXjvLCEnZuQ3rJDE9L)"));
